#include "../../../include/fnx/utils/utf8.hpp"
...
size_t codepoint_byte_size(char32_t codepoint) {
  size_t len = 0;
...
char32_t to_codepoint(const char8_t *codeunits) {
