...
/// Merges the translation unit's CST into the global AST with
/// Onyx macro and C constant expression evaluation and semantic
/// analysis. Onyx, Lua and C ASTs may be written into by multiple
/// parsers simulataneously, therefore synchronization is required.
class Compiler {
  Lexer *_lexer;
